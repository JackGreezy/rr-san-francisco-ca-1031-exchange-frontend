# LOCATIONS Content Generation — BATCH 02  Items A to F

## Your Mission
Generate SEO optimized content for 6 locations near San Francisco, CA that help users find replacement properties nationwide.

**Critical**
- No boilerplate
- Include San Francisco, CA once in each body
...
1) financial-district — Financial District, CA  Layout: map-first
2) soma — SOMA, CA  Layout: neighborhood
3) mission-bay — Mission Bay, CA  Layout: city
4) marina-district — Marina District, CA  Layout: compact
5) pacific-heights — Pacific Heights, CA  Layout: detailed-location
6) oakland — Oakland, CA  Layout: remote
...
- One reference to San Francisco, CA
